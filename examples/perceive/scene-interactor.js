 ...
 * mouseover */
var SceneInteractor = function(physics_scene, scene_node, svg, width) {
...
SceneInteractor.prototype.init = function() {
  ...
  this.mousePoint = new Box2D.Common.Math.b2Vec2(0,0);
...
SceneInteractor.prototype.addShape = function(container, shape) {
	...
	se.classed('shape', true)
	  ...
	  .on('click', function(d) {
	  	...
	  	obj = d;
	  	if (self.onSelection) self.onSelection(d.object_node, this.selected);
	  });
}
